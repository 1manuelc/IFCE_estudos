...
void renderPencil() {
    Prisma pencil_body(7, 0, 6);
    Vertex top_cone_vtx("vtx_top", 0.0, 0.0, 8.0);
    Cone pencil_top(25, 1, top_cone_vtx, 6);
    Cone pencil_black(25, 0.251, top_cone_vtx, 7.5);

    pencil_body.render3d(GL_POLYGON);
    pencil_top.render3d(GL_POLYGON);
    pencil_black.render3d(GL_POLYGON);
}
