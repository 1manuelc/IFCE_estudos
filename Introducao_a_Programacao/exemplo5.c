/* 05 - Escrever um programa em C que leia o público total de um jogo de futebol e forneça a renda do jogo, sabendo que haviam 4 tipos de ingressos e que eles foram assim distribuídos:
