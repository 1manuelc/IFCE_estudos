 ...
 */
package S4.Topicos_especiais_em_Programacao.Atividade08_04etapa02.atv04_questao02.src.main.java.manuelc.atv04_questao02;
...
public class CalculoIMC extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnCalcular.setIcon(new javax.swing.ImageIcon("C:\\Users\\Off\\Desktop\\icons\\calculator.png")); // NOI18N
        ...
        btnLimpar.setIcon(new javax.swing.ImageIcon("C:\\Users\\Off\\Desktop\\icons\\bullet_delete.png")); // NOI18N
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {btnCalcular, btnLimpar});
        ...
        jPanel2Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {txtAltura, txtPeso});
    ...
    private String analisarIMC(double imc) {
        if(imc < 17.0) return "muito abaixo do peso";
        else if(imc < 18.5) return "abaixo do peso";
        else if(imc < 25.0) return "peso normal";
        else if(imc < 30.0) return "acima do peso";
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        try {
            ...
            txtResultado.setText(String.format("IMC = %.2f: %s", imc, analisarIMC(imc)));
            limparCampos();
